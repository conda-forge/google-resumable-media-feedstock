About google-resumable-media-feedstock
======================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-resumable-media-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-resumable-media-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-resumable-media
# for installing globally
pixi global install google-resumable-media
```
...
It is possible to list all of the versions of `google-resumable-media` available on your platform:
...
```
pixi search google-resumable-media --channel conda-forge
```
